        ...
        >
            <div className="max-w-[800px] mx-auto text-center flex flex-col items-center gap-6">
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                >
                    I'm excited to meet other professionals and look for chances where I can help, learn, and grow as a developer. 
                    If you have a project, collaboration, or opportunity in mind, please reach out. I’d love to hear from you!
                </motion.p>
                <motion.a
                    href="mailto:jyothiofficial0309@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block mt-4 px-8 py-3 sm:px-10 sm:py-4 bg-white/10 dark:bg-neutral-900/10 border border-blue-400 text-blue-400 font-semibold rounded-2xl shadow-lg backdrop-blur-md transition duration-300  hover:bg-blue-400 dark:hover:bg-blue-400 hover:text-white hover:shadow-blue-500/50 dark:hover:text-black"
                ...
                >
                    {/* GitHub */}
                    <SocialIcon
                        href="https://github.com/JYOTHIkudipudi"
                    ...
                    {/* LinkedIn */}
                    <SocialIcon
                        href="https://linkedin.com/in/jyothi03"
                        title="linkedin.com/in/jyothi03"
                        color="blue"
                    >
                        <svg
                            fill="currentColor"
