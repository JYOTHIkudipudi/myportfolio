...
const FloatingResumeButton = () => {
    ...
    return (
        <motion.a
            ...
            className="group hover:shadow-blue-600/20 fixed bottom-15 right-6 z-50 flex items-center bg-blue-600 text-white font-bold pl-3 py-2 rounded-full shadow-lg overflow-hidden cursor-pointer"
        >
            {/* File Icon */}
            <svg
