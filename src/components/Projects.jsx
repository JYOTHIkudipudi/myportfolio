...
const projectsData = [
    {
        img: projectAWS,
        title: "AWS Automation using Python & Boto3",
        description: `Automated AWS services (EC2, S3, Lambda, CloudWatch) using Python scripts, reducing manual cloud setup effort by 80%.`,
        services: "Python • Boto3 • AWS Cloud Services",
        liveDemo: "#", // Add live demo link if available
        repo: "https://github.com/JYOTHIkudipudi/PythonAutomation-for-AWS-Services",
