                ...
                <div className="max-w-[1440px] h-[100%] mx-auto my-0 flex flex-col items-center pb-9">
                    <div className="flex flex-col justify-center items-start pt-16 w-11/12">
                        ...
                        <div className="flex flex-col items-center gap-4">
                            ...
                            {/* blue underline */}
                            <motion.span
                                className="h-1 bg-blue-400 mt-1"
                                initial={{ width: 0 }}
      ...
      My goal is to grow as a developer and create solutions that have a positive impact.
                            ...
                            <div className="flex md:flex-row flex-col justify-center gap-6 mt-4">
                                {infoBoxes.map((item, index) => (
                                    <motion.div
                                        key={index}
                                        className="bg-white/10 backdrop-blur-sm text-white md:px-6 py-4  rounded-2xl shadow-lg border border-blue-300 min-w-[200px] text-center"
                                        ...
                                        viewport={{ once: true }}
                                    >
                                        <div className="md:text-sm text-sm text-blue-200 font-medium">
                                            {item.title}
                                        </div>
                            ...
                            >
                                ...
                                <SocialIcon
                                    ...
                                    title="github.com/JYOTHIkudipudi"
                                    color="gray"
                                >
                                    <svg
                                        fill="currentColor"
                                ...
                                {/* LinkedIn */}
                                <SocialIcon
                                    href="https://www.linkedin.com/in/jyothi03/"
                                ...
                                <SocialIcon
                                    ...
                                    title="jyothiofficial0309@gmail.com"
                                    color="red"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
