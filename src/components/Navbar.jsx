...
const links = [
  { label: "ホーム", id: "home", path: "/" },
  { label: "自己紹介", id: "about", path: "/about" },
  { label: "スキル", id: "skills", path: "/skills" },
  { label: "経験", id: "experience", path: "/experience" },
  { label: "プロジェクト", id: "projects", path: "/projects" },
  { label: "実績", id: "achievements", path: "/achievements" },
  { label: "連絡先", id: "contact", path: "/contact" },
];
      ...
      <div className="flex justify-center items-center mt-10 mx-auto max-w-[1440px] select-none">
        <div className="relative w-11/12 h-16 px-2.5 rounded-[40px] outline outline-offset-[-1px] outline-black backdrop-blur-sm inline-flex justify-between items-center bg-black dark:bg-white">
          <h1 className="text-2xl font-bold font-mulish pl-6 cursor-default text-white dark:text-black">
            ジョーティ・クディプディ<span className="text-blue-400"></span>
          </h1>

          {/* Desktop nav links */}
          <div className="hidden md:flex relative gap-4 pr-6 items-center">
            <motion.div
              className="absolute top-[15%] bottom-[15%] py-3 px-3 bg-blue-400 rounded-[50px] z-0"
              initial={false}
              animate={{
                left: indicator.left,
                  ...
                  <div
                    className={`font-mulish text-base tracking-wide font-medium transition-colors duration-150 ${
                      isActive
                        ...
                        : "text-white group-hover:text-blue-400 dark:group-hover:text-blue-400 dark:text-black"
                    }`}
                  >
                    {label}
                  </div>
            ...
            <div className="pl-4 md:flex items-center justify-center">
              <button
                onClick={toggleDarkMode}
                className="cursor-pointer p-2 rounded-full transition text-white dark:text-black hover:text-blue-400 dark:hover:text-blue-400"
                aria-label={
          ...
          <div className="md:hidden flex items-center pr-4">
            <button
              onClick={toggleDarkMode}
              className="cursor-pointer p-2 rounded-full transition text-white dark:text-black hover:text-blue-400 dark:hover:text-blue-400 mr-3"
              aria-label={
                isDarkMode ? "Switch to Light Mode" : "Switch to Dark Mode"
              }
            >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.nav
            ...
            transition={{ duration: 0.3 }}
            className="md:hidden bg-black dark:bg-white overflow-hidden rounded-b-2xl px-4"
          >
                    ...
                    <NavLink
                      ...
                      className={`block py-3 px-4 rounded-lg font-mulish font-medium text-lg transition-colors duration-150 ${
                        isActive
                          ...
                          : "text-white hover:bg-blue-400 hover:text-black dark:text-black dark:hover:text-white"
                      }`}
                      onClick={handleClick}
                    >
                      {label}
